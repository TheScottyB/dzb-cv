    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        ...
        case 1:
          // First ensure no conflicting Chrome instances
          _a.sent();
          tempUserDataDir = path_1.default.join(
            os_1.default.tmpdir(),
            'puppeteer_user_data_'.concat(Date.now())
          );
          ...
          return [
            ...
            page.evaluate(function () {
              function getTextContent(selector) {
                ...
                return (
                  ((_a = element === null || element === void 0 ? void 0 : element.textContent) ===
                    null || _a === void 0
                    ? void 0
                    : _a.trim()) || ''
                );
              ...
              var title =
                titleSelectors.map(getTextContent).find(function (text) {
                  return text;
                }) || 'Unknown Position';
              var company =
                companySelectors.map(getTextContent).find(function (text) {
                  return text;
                }) || 'Unknown Company';
              var location =
                locationSelectors.map(getTextContent).find(function (text) {
                  return text;
                }) || 'Unknown Location';
              var description =
                descriptionSelectors.map(getTextContent).find(function (text) {
                  return text;
        ...
        case 21:
          ...
          return [
            4 /*yield*/,
            promises_1.default.writeFile(path_1.default.join(outputDir, 'job.html'), html),
          ];
        case 22:
          _a.sent();
          ...
          return [
            ...
            promises_1.default.writeFile(
              path_1.default.join(outputDir, 'job-data.json'),
        ...
        case 27:
          ...
          return [
            4 /*yield*/,
            promises_1.default.rm(tempUserDataDir, { recursive: true, force: true }),
          ];
        case 28:
          _a.sent();
          return [3 /*break*/, 30];
