...
describe('List and ListItem Components', () => {
  ...
  it('applies marker type correctly', () => {
    ...
    expect(screen.getByRole('list')).toHaveClass('marker-disc');
    ...
    expect(screen.getByRole('list')).toHaveClass('marker-circle');
    ...
    expect(screen.getByRole('list')).toHaveClass('marker-none');
  });
  ...
  it('applies spaced property correctly', () => {
    ...
    expect(screen.getByRole('list')).toHaveClass('spaced');
  });
