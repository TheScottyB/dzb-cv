...
function validateLinkedInJob(result) {
  ...
  console.log(
    '- Has all responsibilities:',
    expectedValues.responsibilities.every((r) => result.responsibilities.includes(r))
  );
  console.log(
    '- Has all skills:',
    expectedValues.skills.every((s) => result.keyTerms.programming?.includes(s))
  );
}
...
function validateIndeedJob(result) {
  ...
  console.log(
    ...
    expectedValues.requirements.every((r) => result.qualifications.includes(r))
  );
}
