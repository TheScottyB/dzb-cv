...
import { loadTemplate, registerHelpers, sortByDate, formatUSDate, formatFederalDateRange, calculateGradeLevel, calculateTotalYears, formatSalary, defaultValue, formatWithPrefix } from "../.tmp/artefacts/dist/utils/helpers.js";
import { resolveDataPath } from "../.tmp/artefacts/dist/utils/path-resolver.js";
import { convertMarkdownToPdf, DEFAULT_PDF_OPTIONS } from '../.tmp/artefacts/dist/utils/pdf-generator.js';
/**
