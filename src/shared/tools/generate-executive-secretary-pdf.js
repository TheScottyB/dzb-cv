...
/**
 * Generate a PDF from the tailored CV for the Executive Secretary II position at DHS
 */
async function main() {
  try {
    ...
    const pdfOptions = {
      ...
      headerText: 'Dawn Zurick Beilfuss - Executive Secretary II (Upward Mobility)',
      footerText: `Application for Illinois DHS Position - Job ID: 43240 | ${new Date().toLocaleDateString()}`,
