...
- Leadership
  `;
    ...
    function arrayHasMatching(array, regex) {
    ...
    function assertOptimizationsAreHumanReadable(arr) {
        arr.forEach(opt => {
    ...
    describe('Content Optimization', () => {
        test('improves formatting while preserving content', async () => {
            ...
            expect(result.optimizations).toEqual(expect.arrayContaining([
...
//# sourceMappingURL=ats-integration.test.js.map