...
Examples:
  ...
  try {
    ...
    if (result.jobType) console.log(`Job Type: ${result.jobType}`);
    if (result.experienceLevel) console.log(`Experience Level: ${result.experienceLevel}`);
